...
class CreateInvoice:
    ...
    def create_products_list(self):
        label4 = tk.Label(self.window, bg=self.bg)
        label4.pack(side=tk.TOP, anchor='w')

        self.prod_list = Treeview(label4, height=24)
    ...
    def create_invoice_window(self):
        ...
        # First row
        label1 = tk.Label(self.window, bg=self.bg)
        label1.pack(side=tk.TOP, anchor='w')

        invoice_no = tk.Label(label1, bg=self.bg, text="Invoice number: ", font=font, height=2, padx=5, pady=1)
        ...
        issue_date = tk.Label(label1, bg=self.bg, text="Issue date: ", font=font, height=2)
        ...
        paid = tk.Label(label1, bg=self.bg, text="Payment: ", font=font, height=2)
        ...
        # Second row
        label2 = tk.Label(self.window, bg=self.bg)
        label2.pack(side=tk.TOP, anchor='w')

        name = tk.Label(label2, bg=self.bg, text="Contractor name: ", font=font, height=1, padx=4)
        ...
        nip = tk.Label(label2, bg=self.bg, text="NIP: ", font=font, height=1)
        ...
        # Third row - buttons
        label3 = tk.Label(self.window, bg=self.bg)
        ...
        label5 = tk.Label(self.window, bg=self.bg)
